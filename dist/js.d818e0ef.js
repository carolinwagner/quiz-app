...
var darkmodeSwitch = (0, _util.get)('.button__darkmode');
var form = (0, _util.get)('.create__form'); //bookmark

var buttonBookmark = (0, _util.get)('.card__bookmark-button');
var bookmarks = document.querySelectorAll('.question__bookmark');
...
var textShowAnswer = (0, _util.get)('.text-answer');
var buttonShowAnswer = (0, _util.get)('.card__answer-button');
